    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(related_name='comments', to='blog.Blog')),
                ('parent', mptt.fields.TreeForeignKey(related_name='children', blank=True, to='blog.Comment', null=True)),
                ('reply_to', models.ForeignKey(related_name='replyers', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
